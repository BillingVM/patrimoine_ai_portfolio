...
<aside class="sidebar">
    ...
    <nav class="sidebar-nav">
        ...
        <a href="javascript:void(0);" class="sidebar-link" title="Chat History" onclick="openChatHistoryModal()">
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor">
        ...
        <script>
        // Global function for chat history modal
        function openChatHistoryModal() {
            // If on chat page and chatInstance exists, use it
            if (typeof window.chatInstance !== 'undefined' && window.chatInstance.openChatHistoryModal) {
                window.chatInstance.openChatHistoryModal();
            } else {
                // Redirect to chat page with history parameter
                window.location.href = '/portai/public/index.php?openHistory=1';
            }
        }
        </script>
